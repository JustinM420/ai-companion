...
const formSchema = z.object({
    ...
    instructions: z.string().min(200, {
        message: "instrunctions require atleast 200 characters."
    }),
                    ...
                    <FormField 
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            This is where you give your companion a detailed identity
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField 
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Provide an example conversation to teach your companion how to behave
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
